<template>
  <div class="chess">
    <banner :slides="slides" :inv="4000" :isShowIndicator="false" :height="500"></banner>
    ...
    <div class="game-content">
      ...
      <div class="game-list-wrapper wrapper">
        <div class="item" v-for="item in filterList">
          ...
          <div class="bottom">
            <p>{{item.title}}</p>
              <p v-if="item.testmode">
                  <el-button @click="playtestGameCommon(item)" type="warning" round plain>免费试玩</el-button>
              </p>
...
<script>
  ...
  const TYPE_MW = 'mw'
  const TYPE_dt = 'dt'
  import {kyqpLogin,cg761Login,mwgLogin,cardDtLogin} from '@/api/index'

<template>
    <div class="safe">
        ...
        <div class="s_conter">
            <div>
                <img class="bgs" src="./img/bg.png" alt="">
            </div>
            <div class="top_box">
                <ul>
                    ...
                    <div class="section1">
                        ...
                        <div class="section1_box">
                            <div class="section1_box_input">
                                <input v-model="number" type="text" value="" placeholder="请输入您的手机号码" id="phone"/>
    ...
    data() {
      return {
        ...
        flist: [
          {
            text: '账号问题',
            img:require('./img/i1.png'),
            id: 'userqustion'
          },
          {
            text: '资金问题',
            img:require('./img/i2.png'),
            id: 'cashqustion'
          },
          {
            text: '优惠问题',
            img:require('./img/i3.png'),
            id: 'offerquestion'
          },
          {
            text: '游戏问题',
            img:require('./img/i4.png'),
            id: 'gamequestion'
          },
          {
            text: '技术问题',
            img:require('./img/i5.png'),
            id: 'techquestion'
          },
        ...
        tlist: [
          {
            text: '免费注册',
            img:require('./img/i6.png'),
            id: 'register'
          },
          {
            text: '自助返水',
            img:require('./img/i7.png'),
            id: 'funds'
          },
          {
            text: '找回账号',
            img:require('./img/i8.png'),
            id: 'username'
          },
          {
            text: '找回密码',
            img:require('./img/i9.png'),
            id: 'password'
          },
          {
            text: '账号解锁',
            img:require('./img/i10.png'),
            id: 'unuser'
          },
          {
            text: '解绑银行',
            img:require('./img/i11.png'),
            id: 'uncard'
          },
        ],
        isServerwx: false,

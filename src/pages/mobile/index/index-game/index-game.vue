...
//          },
          ...
          {
            type: TYPES.fishPoker,
            src: require('./img/dtqp.png'),
            text: 'DT棋牌',
            api: cardDtLogin,
            reqData: {gameCode: 'dezhou520', playMode: 0}
          },
          {
            type: TYPES.fishPoker,
    ...
    methods: {
      ...
      download(item) {
        if (item.category === 'PT') {
          window.location.href = 'http://m.gm175788.com/download.html'
        }
        if (item.category === 'DT') {
          let url = ''

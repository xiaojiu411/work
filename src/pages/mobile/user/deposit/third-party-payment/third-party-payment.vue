  ...
  <div>
    ...
    <div class="pay-options-page">
      ...
      <div v-if="!obj.isThirdPartyPay" class="mobile-input-group">
        ...
        <div>
          <input v-if="userInfo.accountName" v-model="obj.depositName" placeholder="请输入转账的真实姓名" type="text">
          <mt-button @click="bandingAccountName" v-if="!userInfo.accountName" class="small-btn"  type="danger">完善资料</mt-button>
        </div>
      </div>
      <!--存款金额-->
      <div class="mobile-input-group">
    ...
    <div v-if="obj.state" class="confirm-deposit">
      ...
      <div class="confirm-deposit-page">
        ...
        <div class="confirm-info">
          ...
          <div v-if="obj.depositInfo.area && obj.depositInfo.amount>=50000" class="input-group">
            <span class="label">开户地址：</span>
            <div>{{obj.depositInfo.area}}</div>
          </div>
          <div class="input-group">

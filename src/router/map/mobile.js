...
let index1 = () => import('@/pages/mobile/index/index1.vue')
let indexPage = () => import('@/pages/mobile/index/index.vue')
let noticePage = () => import('@/pages/mobile/notice-page/notice-page.vue')
let gameLobby = () => import('@/pages/mobile/game-lobby/game-lobby1.vue')
let gameDown = () => import('@/pages/mobile/game-lobby/game-down.vue')
let login = () => import('@/pages/mobile/login/login.vue')
let newlogin = () => import('@/pages/mobile/login/newlogin.vue')
...
let newregister = () => import('@/pages/mobile/newregister/index.vue')
...
let accountSettings = () => import('@/pages/mobile/user/account-settings/account-settings1.vue')
...
let agent = () => import('@/pages/mobile/user/agent/agent1.vue')

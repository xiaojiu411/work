...
export function newRegister(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/newRegister', data))
}

// 验证码

export function newValidateCodeForIndex(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/newValidateCodeForIndex', data))
}
...
export function getUserByphone(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/getUserByphone', data))
}

//  发送短信验证码到用户

export function sendSmsCodeForUser(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/sendSmsCodeForUser', data))
}

//  查询用户状态

export function findUserStatusInfo(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/findUserStatusInfo', data))
}

//  验证短信验证码是否正确

export function validatePhoneSms(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/validatePhoneSms', data))
}

//  根据手机号绑定指定账号

export function bindAccountByphone(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/bindAccountByphone', data))
}

// 错误密码次数

export function findCustormerStuts(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/findCustormerStuts', data))
}

// 新登陆

export function newLogin(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/newLogin', data))
}

// 校验客户手机号是否已存在并且已经通过校验（可登陆手机号）

export function validateUserPhoneFlag(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/validateUserPhoneFlag', data))
}

// 设置登录密码

export function setLoginPassword(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/setLoginPassword', data))
}

//设置中验证以手机登录

export function alidatePhoneOrEmail(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/alidatePhoneOrEmail', data))
}

//修改会员个人基本信息

export function newEditUserInfo(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/newEditUserInfo', data))
}

//修改手机号码

export function modifyPhone(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/modifyPhone', data))
}

//清空修改密码

export function clearneedModify(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/clearneedModify', data))
}
...
export function gameAginNewRedirect(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/gameAgqjLogin', data))
}
...
export function cardDtLogin(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/gameDTChessLogin', data))
}
...
//YGG
export function gameYGGLogin(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/yggLogin', data))
}
...
// 新年查询实时流水
export function findNewYearActivity(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/findNewYearActivity', data))
}

// 新年领取瓜分红包
export function drawNewYearActivity(data) {
  return Promise.resolve(ajaxFactory('post', '/1.0/drawNewYearActivity', data))
}
